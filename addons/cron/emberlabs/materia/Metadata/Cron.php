 ...
 * @link        https://github.com/damianb/yukari
 */
class Cron extends \emberlabs\materia\Metadata\MetadataBase
{
	/**
	 ...
	 */
	protected $description = 'Hooks onto tick events and dispatches additional events each second, minute, hour, etc.';
	...
	{
		$cron = Kernel::set('yukari.addon.cron', new \Codebite\Yukari\Addon\Cron\Pulse());
		$cron->registerListeners();
	}
