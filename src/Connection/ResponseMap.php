...
/**
 * Yukari - IRC Response Code Map object,
 * 	    Provides abstraction of IRC responses that can received from the server.
 *
 *
 * @category    Yukari
 * @package     irc
...
class ResponseMap
{
	...
	/**
	 * @var array - Array containing the "constant names" for the various response codes.
	 */
	protected $map = array(
		200 => 'RPL_TRACELINK',
	...
	/**
	 * Get the response type string (our internal constant) for the specified response code
	 * @param integer $code - The response code to get the response type string for.
	 * @return mixed - Boolean false if no such response code recognized, or the response type string.
	 */
