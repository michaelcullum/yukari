...
abstract class Kernel
{
	...
	/**
	 * @var \Codebite\Yukari\Environment - The environment object
	 */
	...
	public static function load()
	{
		...
		self::$build_number = (file_exists(\Codebite\Yukari\ROOT_PATH . '/VERSION')) ? file_get_contents(\Codebite\Yukari\ROOT_PATH . '/VERSION') : false;

		// Load the Environment object
		self::setEnvironment(\Codebite\Yukari\Environment::newInstance());
	 ...
	 * @param \Codebite\Yukari\Environment $environment - The environment object.
	 * @return void
	 */
	public static function setEnvironment(\Codebite\Yukari\Environment $environment)
	{
	 ...
	 * @return \Codebite\Yukari\Environment - The environment object.
	 */
